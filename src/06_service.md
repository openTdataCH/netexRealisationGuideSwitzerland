...
### Purpose
A public transport service line with a `Name`, `TransportMode`, and `Operator`. Be aware that the handling of "Konzessionär" and "Betreiber" is a bit complex and is discussed [here](uc17_mixed_lines.md) and [here](09_resources.md#responsibilityset).
