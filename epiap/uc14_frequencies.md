...
The `TemplateServiceJourney` is described in the appropriate [chapter](08_timetable.md#templateservicejourney).

An example for a 30 minutes frequency journey and a continuous one are to be found [here](./examples/12_NeTEx_CH_Frequency_Based_Line.xml).