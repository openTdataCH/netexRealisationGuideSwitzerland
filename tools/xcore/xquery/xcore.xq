...
(: NeTEx split HTML report by complex type :)
declare variable $htmlFilePerComplexType as xs:boolean? external := false();
...
let $options := map{'skipAnno': $skipAnno,
                    ...
                    'withEnumDict': false(),
                    'htmlFilePerComplexType': $htmlFilePerComplexType,
