...
|-----|---------|-------|------|------|-------------|------|
|  | DefaultConnection | expected | 1..1 | None | Specifies the default transfer times to transfer between MODEs and / or OPERATORs within a region. | Connection between two operators on the whole network or on a defined STOP PLACE. |
...
| ++ | OperatorView | mandatory | 1..1 | None | Simplified view of OPERATOR. All data except the identifier will be derived through the relationship. |  |
