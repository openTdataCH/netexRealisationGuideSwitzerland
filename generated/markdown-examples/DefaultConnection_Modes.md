...
|-----|---------|-------|------|------|-------------|------|
|  | DefaultConnection | expected | 1..1 | None | Specifies the default transfer times to transfer between MODEs and / or OPERATORs within a region. | General connection between two modes in the whole network, when not StopPlaceRef is mentioned. Most exist for each mode pair. |
