...
| +++ | [ServiceFrame](ServiceFrame_SITE_OFFER.xml.md) | expected | 1..* | ServiceFrame | A coherent set of Service data to which the same frame VALIDITY CONDITIONs have been assigned. | Used for DefaultConnections and SiteConnections |
