...
| +++ | [ResourceFrame](ResourceFrame.md) | expected | 1..1 | ResourceFrame | A coherent set of reference values for TYPE OF VALUEs , ORGANISATIONs, VEHICLE TYPEs etc that have a common validity, as specified by a set of frame VALIDITY CONDITIONs. Used to define common resources that will be referenced by other types of FRAME. | Only if we really need it |
| +++ | [SiteFrame](SiteFrame.md) | mandatory | 1..1 | SiteFrame | A coherent set of SITE data to which the same frame VALIDITY CONDITIONs have been assigned. |  |
...
| +++ | [ServiceFrame](ServiceFrame_SITE_OFFER.xml.md) | expected | 1..1 | ServiceFrame | A coherent set of Service data to which the same frame VALIDITY CONDITIONs have been assigned. | Used for DefaultConnections and SiteConnections |
