...
| +++ | [ResourceFrame](ResourceFrame.md) | expected | 1..1 | unknown |  | Only if we really need it |
| +++ | [SiteFrame](SiteFrame.md) | mandatory | 1..1 | unknown |  |  |
| +++ | [ServiceCalendarFrame](ServiceCalendarFrame.md) | mandatory | 1..1 | unknown |  | Needed for the relevant AvailabilityConditions |
| +++ | [ServiceFrame](ServiceFrame_SITE_OFFER.xml.md) | expected | 1..1 | unknown |  | Used for DefaultConnections and SiteConnections |
