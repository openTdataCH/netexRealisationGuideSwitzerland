...
|  | QuayRef | expected | 0..1 | QuayRefStructure | Reference to a QUAY. | Not having the track may be problematic, but it can happen sometimes for stops abroad. However, the goal is to always have a QuyRef. |
