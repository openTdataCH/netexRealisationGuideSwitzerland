...
| ++ | TimebandRef | mandatory | 1..* | TimebandRefStructure | Reference to a TIME BAND. | Timeband defined in ServiceCalendarFrame |
...
| + | LineInDirectionRef | expected | 1..1 | LineInDirectionRef_Structure | Reference to a LINE in a specific DIRECTION |  |
...
| + | ServiceJourneyRef | optional | 1..1 | ServiceJourneyRefStructure | Reference to a SERVICE JOURNEY. |  |
