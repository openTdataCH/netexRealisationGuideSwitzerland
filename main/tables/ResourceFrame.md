...
| + | [ResponsibilitySet](ResponsibilitySet.md) | mandatory | 1..* | unknown |  | Each combination of Authority and Operator needs a ResponsibilitySet. |
...
| + | [Operator](Operator.md) | mandatory | 1..1 | unknown |  | We will use this organisation also in AuthorityRef. The problem is that the sboid can be used only once. |
...
| + | [SiteFacilitySet](SiteFacilitySet.md) | optional | 1..* | unknown |  |  |
...
| + | [ServiceFacilitySet](ServiceFacilitySet.md) | optional | 1..* | unknown |  |  |
...
| + | [VehicleType](VehicleType.md) | optional | 1..1 | unknown |  |  |
