...
| + | [AvailabilityCondition](AvailabilityCondition.md) | mandatory | 1..1 | unknown |  | Only a single occurence is allowed. The following elements are mandatory here, any other elements of AvailabilityCondition are not allowed or will be ignored. |
...
| + | TimetabledPassingTime | expected | 1..1 | unknown |  |  |
