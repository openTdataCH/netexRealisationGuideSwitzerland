...
| + | [AlternativeName](AlternativeName.md) | optional | 1..* | unknown | Alternative Name. |  |
...
| + | [Quay](Quay.md) | expected | 1..* | unknown | A place such as platform, stance, or quayside where passengers have access to PT vehicles, Taxi cars or other means of transportation. A QUAY may contain other sub QUAYs. A child QUAY must be physically contained within its parent QUAY. |  |
