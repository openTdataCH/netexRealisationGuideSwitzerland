...
| + | [CompositeFrame](CompositeFrame.md) | mandatory | 1..1 | Composite_VersionFrameStructure | A container VERSION FRAME that groups a set of content VERSION FRAMsE to which the same VALIDITY CONDITIONs have been assigned. |  |
