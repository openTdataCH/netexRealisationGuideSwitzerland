...
| + | [DayTypeAssignment](DayTypeAssignment.md) | optional | 1..1 | DayTypeAssignment | Associates a DAY TYPE with an OPERATING DAY within a specific Calendar. A specification of a particular DAY TYPE which will be valid during a TIME BAND on an OPERATING DAY. | Used for holidays only |
