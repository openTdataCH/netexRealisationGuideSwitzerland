...
| + | [DestinationDisplay](DestinationDisplay.md) | expected | 1..* | unknown |  | We only allow fully formed content of destinationDisplays |
...
| + | [PassengerStopAssignment](PassengerStopAssignment.md) | expected | 1..1 | unknown |  | are only used in a special PSA file in the export. |
...
| + | [TimeDemandType](TimeDemandType.md) | expected | 1..* | unknown |  |  |
