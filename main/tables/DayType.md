...
| + | @lang | mandatory | 1..1 | xsd:string | Attribute lang | |
| + | Text | expected | 0..1 | MultilingualString | Text content of NOTICe. | Italian |
| ++ | @lang | mandatory | 1..1 | xsd:string | Attribute lang | |
| + | Text | expected | 0..1 | MultilingualString | Text content of NOTICe. | French |
| ++ | @lang | mandatory | 1..1 | xsd:string | Attribute lang | |
| + | Text | expected | 0..1 | MultilingualString | Text content of NOTICe. | English |
| ++ | @lang | mandatory | 1..1 | xsd:string | Attribute lang | |
