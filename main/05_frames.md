...
| + | [CompositeFrame](./tables/CompositeFrame.md) | mandatory | 1..* | unknown | A container VERSION FRAME that groups a set of content VERSION FRAMsE to which the same VALIDITY CONDITIONs have been assigned. |  |
...
| + | [TimetableFrame](./tables/TimetableFrame.md) | expected | 1..1 | unknown | A coherent set of timetable data (VEHICLE JOURNEYs and BLOCKs) to which the same VALIDITY CONDITIONs have been assigned. |  |
